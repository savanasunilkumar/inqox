/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 412eab1c493779203db3afb71b62b469)
// Runtime types generated with workerd@1.20260921.1 2026-09-23 nodejs_compat
interface __BaseEnv_Env {
	PROFILES: R2Bucket;
	BROWSER: BrowserRun;
	AI: Ai;
	SERVICE_AUDIENCE: "https://applyit-application-agent.black-poetry-4fa5.workers.dev";
	ALLOWED_SERVICE_ACCOUNTS: "applyit-jobs-runtime@aniflixx-production.iam.gserviceaccount.com,aniflixx-api@aniflixx-production.iam.gserviceaccount.com";
	JEV_MODEL: "jev-latest";
	CLERK_AUTHORIZED_PARTIES: "https://inqox.com";
	TYPESAFE_API_KEY: string;
	NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY: string;
	CLERK_SECRET_KEY: string;
	ApplicationAgent: DurableObjectNamespace<import("./src/index").ApplicationAgent>;
	LiveApplicationAgent: DurableObjectNamespace<import("./src/index").LiveApplicationAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ApplicationAgent" | "LiveApplicationAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_AUDIENCE" | "ALLOWED_SERVICE_ACCOUNTS" | "JEV_MODEL" | "CLERK_AUTHORIZED_PARTIES" | "TYPESAFE_API_KEY" | "NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
