/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f9705a55765266a7f2bd74ad58882e80)
// Runtime types generated with workerd@1.20260921.1 2026-09-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	JOBS_API_BASE_URL: "https://applyit-jobs-api-iyx36e4y3q-uc.a.run.app";
	WORKER_SELF_REFERENCE: Fetcher /* inqox-web */;
	APPLICATION_AGENT: Service /* entrypoint Frontend from applyit-application-agent */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JOBS_API_BASE_URL">> {}
}
